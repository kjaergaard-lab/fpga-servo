# 
# Project automation script for quad-servo 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source quad-servo.tcl), then you can
...
set myProject "quad-servo"
set myScript "quad-servo.tcl"
...
proc add_source_files {} {
   ...
   xfile add "ipcore_dir/s6_lpddr_4channel/user_design/rtl/iodrp_controller.vhd"
   xfile add "ipcore_dir/s6_lpddr_4channel/user_design/rtl/iodrp_mcb_controller.vhd"
   xfile add "ipcore_dir/s6_lpddr_4channel/user_design/rtl/mcb_raw_wrapper.vhd"
   xfile add "ipcore_dir/s6_lpddr_4channel/user_design/rtl/mcb_soft_calibration.vhd"
   xfile add "ipcore_dir/s6_lpddr_4channel/user_design/rtl/mcb_soft_calibration_top.vhd"
   xfile add "ipcore_dir/s6_lpddr_4channel/user_design/rtl/memc3_infrastructure.vhd"
   xfile add "ipcore_dir/s6_lpddr_4channel/user_design/rtl/memc3_wrapper.vhd"
   xfile add "ipcore_dir/s6_lpddr_4channel/user_design/rtl/s6_lpddr_4channel.vhd"
   xfile add "sources/Constants.vhd"
   xfile add "sources/Constraints.ucf"
   xfile add "sources/LPDDRController_4channel.vhd"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/nkgroup/Xilinx/fpga-servo/quad-servo/xst" -process "Synthesize - XST"
