# 
# Project automation script for dual-servo 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source dual-servo.tcl), then you can
...
set myProject "ip-trap-servo"
set myScript "ip-trap-servo.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../vhdl-common/ADCMemRWControl.vhd"
   # xfile add "../vhdl-common/Analog_Digital_Control.vhd"
   xfile add "../vhdl-common/Count_Edges.vhd"
   xfile add "../vhdl-common/PID_Controller.vhd"
   xfile add "../vhdl-common/Procedures.vhd"
   xfile add "../vhdl-common/ReadData.vhd"
   xfile add "../vhdl-common/SPI_Driver.vhd"
   xfile add "../vhdl-common/SampleGenerator.vhd"
   xfile add "../vhdl-common/SerialCommunication.vhd"
   xfile add "../vhdl-common/UART_Receiver.vhd"
   xfile add "../vhdl-common/UART_Transmitter.vhd"
   xfile add "ipcore_dir/K_Multiplier.xco"
   xfile add "ipcore_dir/dcm1.xco"
   xfile add "ipcore_dir/s6_lpddr_2channel/user_design/rtl/iodrp_controller.vhd"
   xfile add "ipcore_dir/s6_lpddr_2channel/user_design/rtl/iodrp_mcb_controller.vhd"
   xfile add "ipcore_dir/s6_lpddr_2channel/user_design/rtl/mcb_raw_wrapper.vhd"
   xfile add "ipcore_dir/s6_lpddr_2channel/user_design/rtl/mcb_soft_calibration.vhd"
   xfile add "ipcore_dir/s6_lpddr_2channel/user_design/rtl/mcb_soft_calibration_top.vhd"
   xfile add "ipcore_dir/s6_lpddr_2channel/user_design/rtl/memc3_infrastructure.vhd"
   xfile add "ipcore_dir/s6_lpddr_2channel/user_design/rtl/memc3_wrapper.vhd"
   xfile add "ipcore_dir/s6_lpddr_2channel/user_design/rtl/s6_lpddr_2channel.vhd"
   xfile add "sources/Constants.vhd"
   xfile add "sources/Constraints.ucf"
   xfile add "sources/LPDDRControl_2channel.vhd"
   xfile add "sources/topmod.vhd"
   xfile add "sources/Analog_Digital_Control.vhd"
   puts ""
   puts "WARNING: project contains IP cores, synthesis will fail if any of the cores require regenerating."
   puts ""

   # Set the Top Module as well...
   project set top "Behavioral" "topmod"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/nkgroup/Xilinx/fpga-servo/dual-servo/xst" -process "Synthesize - XST"
