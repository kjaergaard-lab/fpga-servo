%programServo_ArbSamples_VariableGain Example file that shows how to use the SERVO and SERVOCMD
%methods to program a particular sequence into the servo controller.
%
%   This file demonstrates how to use arbitrary voltage signals with
%   variable gains
%
...
sv.useFixed.set(0);                         %Use variable gains only
...
Kp = 250*ones(size(V));                     %Set the proportional gain as a function of time to be constant
Ki = 120*ones(size(V));                     %Set the proportional gain as a function of time to be constant
Kd = 100*ones(size(V));                     %Set the derivative gain as a function of time to be constant
N = 15*ones(size(V));                       %Set the overall divisor as a function of time to be constant
